...
<body>
    ...
    <footer id="footer" class="footer mt-5">
        <div class="copyright">
            &copy; Copyright <strong><span class="text-info">Dragon City</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
            {{-- Designed by <a href="https://bootstrapmade.com/">The EBIT Group</a> --}}
            Designed by <strong><span>The EBIT Group</span></strong>

        </div>
    </footer><!-- End Footer -->

    <!-- ======= Up Arrow ======= ----->
    <a href="#" class="back-to-top d-flex align-items-center justify-content-center bg-info"><i
